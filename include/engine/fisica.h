...
extern directionalLight_t light;
...
void stepMRUV(kinematicInfo_t* kinInfo, float dt); //pra mover objeto levando em conta aceleração. Usa método de velocity verlet, deve ser bom o suficiente
void stepMRU(kinematicInfo_t* kinInfo, float dt); //pra mover objeto de acordo com velocidade ignorando aceleração
